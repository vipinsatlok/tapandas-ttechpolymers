        ...
        <>
            <Menu as="div" className="search-box flex relative py-4 z-20">
                <Menu.Button as="div" className="search-icon cursor-pointer flex pr-2">
                    <img src="/assets/imgs/template/icon-search.svg" alt="dark/light" className="flex-shrink-0 relative dark:hidden" />
                    <img src="assets/imgs/template/icon-search-white.svg" alt="dark/light" className="flex-shrink-0 relative hidden dark:inline-block" />
                </Menu.Button>
