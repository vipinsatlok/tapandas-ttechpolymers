                                    ...
                                    <div className="flex-col justify-start items-start gap-3.5 flex">
                                        <div className="justify-start items-center gap-5 inline-flex">
                                            ...
                                            <div className="justify-start items-center gap-2 flex">
                                                <Link href="/author"><img className="w-9 h-9 rounded-3xl" src="/assets/imgs/avatar/avatar-01.png" /></Link>
                                                <div className="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700">
                                                    <Link href="/author">Alida</Link> - June 8, 2024</div>
                                            </div>
                                        </div>
                                        <h3><Link className="text-neutral-950 dark:text-neutral-dark-950 text-2xl font-bold leading-snug item-link" href="/single">Brushstrokes of Life: A Creative Journey Unveiled</Link></h3>
                    ...
                    <section className="relative pt-20 py-10 lg:pt-12 lg:pb-24">
                        <div className="container px-4">
                            <div className="flex flex-col justify-start mb-16 items-start lg:flex-row lg:justify-between lg:items-end">
                                ...
                                <div className="justify-start items-start gap-2 inline-flex flex-wrap mb-3">
                            ...
                            <div className="flex flex-col gap-16">
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-[30px] gap-y-[65px]">
                                    <BlogPost showItem={6} style={2} startFrom={5} toEnd={17} showPagination/>
                                </div>
                            </div>
                        </div>
                    </section>
